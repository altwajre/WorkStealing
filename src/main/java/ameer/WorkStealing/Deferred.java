...
public class Deferred<T> {
    ...
    if(this.value==null)throw new IllegalStateException("not yet resolved");
     return value;
    }
    ...
    public void resolve(T value) {
     ...
     // if(this.value!=null)throw new IllegalStateException("already resolved");
      synchronized (this) {
    	  this.value=value;
      	resolved = true;
	}
